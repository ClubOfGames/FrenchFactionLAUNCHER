...
class ProcessBuilder {
    ...
    build(){
        ...
        child.on('close', (code, signal) => {
            logger.log('Sortie avec le code', code)
    ...
    _constructJVMArguments112(mods, tempNativePath){
        ...
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=FrenchFactionLauncher')
    ...
    _constructJVMArguments113(mods, tempNativePath){
        ...
        if(isAutoconnectBroken) {
            logger.error('Connexion automatique au serveur désactivée sur Forge 1.15.2 pour les versions antérieures à 31.2.15 en raison d\'un problème de débordement de pile OpenGL.')
