...
document.getElementById('launch_button').addEventListener('click', function(e){
    ...
    if(jExe == null){
        ...
        jg._validateJavaBinary(jExe).then((v) => {
            loggerLanding.log('Version du meta de java', v)
            if(v.valid){
                dlAsync()
            } else {
                asyncSystemScan(mcVersion)
...
const refreshMojangStatuses = async function(){
    loggerLanding.log('Rechargement du statut Mojang...')
    ...
    if(response.responseStatus === RestResponseStatus.SUCCESS) {
        ...
        loggerLanding.warn('Erreur du rechargement des statuts Mojang.')
...
const refreshServerStatus = async function(fade = false){
    loggerLanding.log('Rechargement des statuts des serveurs.')
...
function asyncSystemScan(mcVersion, launchAfter = true){
    ...
    sysAEx.on('message', (m) => {
        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    'Compatibilité Impossible<br>Installation de Java trouvée.',
                    'Pour rejoindre FrenchFaction, vous avez besoin d\'une installation 64 bits de Java 8. Souhaitez-vous que nous en installions une copie ?',
                    'Installer Java',
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(
                            'Jave est Obligatoire<br>Lancer l\'installation',
                            'Une installation x64 valide de Java 8 est requise pour le lancement.<br><br>Veuillez consulter notre <a href="https://github.com/dscalzi/HeliosLauncher/wiki/Java-Management#manually-installing-a-valid-version-of-java">Guide Java</a> pour obtenir des instructions sur l\'installation manuelle de Java.',
                            'Je comprend',
                            'Retour '
                        )
                        setOverlayHandler(() => {
            ...
            if(m.result === true){
                ...
                setOverlayContent(
                    'Problème inattendu:<br>Installation de Java échouée',
    ...
    setLaunchDetails('Check-up des infos de votre système...')
...
function dlAsync(login = true){
    ...
    aEx.on('close', (code, signal) => {
        if(code !== 0){
            loggerLaunchSuite.error(`Il s\'emblerait que AssetExec a planté avec le code ${code}, redémarrage des services...`)
            ...
            switch(m.data){
                case 'download':
                    ...
                    if(m.error.code === 'ENOENT'){
                        ...
                        showLaunchFailure(
                            'Erreur de téléchargement',
                            'Référez vous à la console (CTRL + Shift + i) pour plus de détails. Réessayer ensuite.'
                        )
                    }
            ...
            if(login && allGood) {
                ...
                const gameStateChange = function(data){
                    ...
                    if(SERVER_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Explorer les Realms !')
                    } else if(GAME_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Naviguer vers FrenchFaction !')
                    }
                }
                ...
                try {
                    ...
                    setLaunchDetails('Terminé ! Bonne aventure !')
                    ...
                    if(distro.discord != null && serv.discord != null){
                        ...
                        proc.on('close', (code, signal) => {
                            loggerLaunchSuite.log('Arrêt de Discord Rich Prescense...')
    ...
    refreshDistributionIndex(true, (data) => {
        ...
        refreshDistributionIndex(false, (data) => {
            ...
            if(DistroManager.getDistribution() == null){
                showLaunchFailure('Erreur CRITIQUE', 'Impossible de charger une copie de l\'index de distribution. Référez vous à la console (CTRL + Shift + i) pour plus de détails.')
